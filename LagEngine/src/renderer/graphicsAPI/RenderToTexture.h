...
namespace Lag {
    ...
    public:
        RenderToTexture(uint32 width, uint32 height, RenderPhase renderPhase = RenderPhase::COLOR);
    ...
    protected:
        ...
        Handle<Texture>
        createAndLoadTexture(const std::string &name, const ImageData &imageData, const TextureData &textureData);
    };
}
